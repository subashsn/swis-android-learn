/*
package co.swisapp.loginmapload.UI.Fragments;
...
import co.swisapp.loginmapload.UI.CustomViews.AutoFitTextureView;
...
/**
    ...
    private static Integer REQUEST_VIDEO_PERMISSIONS = 1;
    */
/**
...
/**
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        //view.findViewById(R.id.button_video_record).setOnClickListener(this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance("GImme permission")
