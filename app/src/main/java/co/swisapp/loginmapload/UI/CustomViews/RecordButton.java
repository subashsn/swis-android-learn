package co.swisapp.loginmapload.UI.CustomViews;
...
public class RecordButton extends View {
    ...
    private void initialize() {
        ...
        recordButtonPaint.setColor(ContextCompat.getColor(getContext(), R.color.record_button_inner_red));
        ...
        percentRingPaint.setColor(ContextCompat.getColor(getContext(), R.color.record_button_inner_red));
